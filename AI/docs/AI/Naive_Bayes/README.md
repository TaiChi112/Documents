# 📘 บทที่ 7 : ทฤษฎีของเบย์และโมเดลการจำแนก (Naive Bayes)
...
| $P(f_i | C)$                                        | ความน่าจะเป็นของคุณลักษณะภายใต้คลาสนั้น |
...
| สูตร     | ชื่อ                               | คำอธิบาย            |
| :------ | :------------------------------- | :---------------- |
| $P(H    | E) = \frac{P(E                   | H)P(H)}{P(E)}$    | Bayes’ Theorem           | ความน่าจะเป็นแบบมีเงื่อนไข |
| $P(C    | f_1,…,f_n) ∝ P(C)\prod P(f_i     | C)$               | Naive Bayes              | การจำแนกหลายคุณลักษณะ    |
| $P(word | class)=\frac{count+α}{total+αV}$ | Laplace smoothing | ป้องกันค่าความน่าจะเป็นเป็นศูนย์ |
